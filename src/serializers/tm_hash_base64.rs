...
use celestia_core::hash::{Algorithm::Sha256, Hash, SHA256_HASH_SIZE};
use serde::{Deserialize, Deserializer, Serializer};
use subtle_encoding::base64;

use crate::prelude::*;

/// Deserialize a base64-encoded string into an celestia_core::Hash
...
/// Serialize from a celestia_core::Hash into a base64-encoded string
