...
/// Deserialize base64-encoded string into an Option<celestia_core::Hash>
...
/// Serialize from an Option<celestia_core::Hash> into a base64-encoded string
